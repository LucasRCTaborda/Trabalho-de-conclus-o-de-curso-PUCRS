...
\begin{figure}[H]
    \centering
    \small
    \caption{Modelo de dados Amores Fati}
    \includegraphics[width=1\linewidth]{conteudo//3 - ages II//conteudo//figures/BancoDadosAF.png}
    Fonte: Arquivos pessoais
    \label{fig:banco-amores-fati}
\end{figure}
...
\begin{figure}[H]
    \centering
    \small
    \caption{Arquitetura Amores Fati}
    \includegraphics[width=1\linewidth]{conteudo//3 - ages II//conteudo//figures/ArquiteturaAF.png}
    Fonte: Arquivos pessoais
    \label{fig:arquitetura-amores-fati}
\end{figure}

\begin{figure}[H]
    \centering
    \small
    \caption{Arquitetura Amores Fati (detalhada)}
    \includegraphics[width=1\linewidth]{conteudo//3 - ages II//conteudo//figures/ArquiteturaAF2.png}
    Fonte: Arquivos pessoais
    \label{fig:arquitetura-amores-fati-2}
\end{figure}
